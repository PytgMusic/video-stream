...
@Client.on_message(command(["skipa", f"skipa@{BOT_USERNAME}", "vskip"]) & other_filters)
@authorized_users_only
async def skip(client, m: Message):
    ...
    keyboard = InlineKeyboardMarkup(
        [
            [
                InlineKeyboardButton(
                    text="🎛️ Mᴇɴᴜ", callback_data="cbmenu"
                ),
                InlineKeyboardButton(
...
@Client.on_message(
    command(["stopa", f"stopa@{BOT_USERNAME}", "end", f"end@{BOT_USERNAME}", "vstop"])
    & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["pausehell", f"pausehell@{BOT_USERNAME}", "vpause"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["resumehell", f"resumehell@{BOT_USERNAME}", "vresume"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["mutea", f"mutea@{BOT_USERNAME}", "vmute"]) & other_filters
)
@authorized_users_only
...
@Client.on_message(
    command(["unmutea", f"unmutea@{BOT_USERNAME}", "vunmute"]) & other_filters
)
@authorized_users_only
